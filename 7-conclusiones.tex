...
El desarrollo del presente proyecto ha permitido alcanzar los objetivos planteados inicialmente, 
logrando no solo una obtención de conocimientos en 
...
En primer lugar, el análisis completo y la comparativa de las distintas herramientas
...
de equipos especializados, ha demostrado que es posible obtener 
...
visión global del sector audiovisual. Los resultados obtenidos confirman 
que, con una base teórica sólida y un uso estratégico de los recursos digitales actuales,
es posible transformar una idea creativa en un producto óptimo. Este aprendizaje no solo consolida competencias técnicas en 
edición, sino que nos ha proporcionado una visión crítica sobre contenidos multimedia que será de
