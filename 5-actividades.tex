...
\begin{figure}[H]
    ...
    \caption{Nombres generados para el trailer de superhéroes}
...
Para realizar el montaje de un vídeo, debemos de arrastrar los clips de los que 
queremos disponer a la línea temporal. Despues, procederemos a cortar las partes
no deseadas de cada clip. En Davinci Resolve, 
