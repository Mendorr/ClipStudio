...
necesario introducir la herramienta utilizada. DaVinci Resolve destaca por integrar en una única 
...
\begin{itemize}
    ...
    \begin{figure}[H]
        ...
        \caption{Funcionalidades generales sobre la interfaz de la herramienta}
    ...
    \begin{figure}[H]
        ...
        \caption{Procesador multimedia que dispone la interfaz}
    ...
    \begin{figure}[H]
        ...
        \caption{Funcionalidades especificas para las vistas de la interfaz}
...
\begin{figure}[H]
    ...
    \caption{Modulos de trabajo que ofrece DaVinci Resolve}
...
\begin{figure}[H]
    ...
    \caption{Importar contenido multimedia a línea temporal}
...
\begin{figure}[H]
    ...
    \caption{Ventana de exportación de vídeo}
    \label{fig:exportacion_video}
\end{figure}

\subsection{Ideas descartadas}
...
a los objetivos del proyecto o que presentaban dificultades técnicas insuperables. Algunas de las ideas descartadas incluyen:
 ...
 \subsubsection{Escena de terror}
...
vídeos grabados por nosotros mismos, se consideró que esta idea no era viable debido a la falta de recursos y experiencia en la creación
...
\subsubsection{Trailer de superhéroes}
...
de un trailer de superhéroes. Utilizando como inspiración personajes populares de Marvel como Daredevil o Punisher,
...
Se hicieron esbozos de un guión para el trailer. En la primera y única escena con diálogos del mismo, un héroe emergente, Din, iría
en busca de un antiguo vigilante, Sam, altamente inspirado en Punisher. Este último se encuentra retirado debido a que sus actividades
heroicas le han llevado a perder a su familia a manos de un villano, el Cuervo. Din, trás descrubir el paradero del villano,
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{assets/titulo-trailer.png}
    \caption{Nombre generados para el trailer de superhéroes}
...
\subsubsection{Tutorial de edición de vídeo}
...
incorporaría un personaje animado sencillamente en 2D que sería el encargado de explicar las técnicas de edición.
...
\subsection{Formalización de la idea}
Finalmente, debido a las limitaciones encontradas en las ideas anteriores, se decidió optar por un montaje con tono humorístico, inspirado en ciertos
...
del personaje Spider-Man, nunca dejando claro si es el propio héroe o alguien que se disfraza del mismo. Los efectos de vídeo
más psicódelicos se utilizaron para mostrar el estado mental del protagonista, mostrando su descenso a la locura.

El ritmo del vídeo consta claramente de dos partes diferenciadas. La primera, con un ritmo más pausado, en la que se muestra
...
acompañado de una música más agresiva. En referencia a las últimas películas del personaje como Homecoming, Far From Home o
No Way Home, se optó por el título Spider-Man: Home-less.(Véase Figura~\ref{fig:Spiderman-homeless}).


\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{assets/Spider-man-Home-less.jpg}
    \caption{Concept art generado con IA}
...
integrantes, la cámara de un POCO X7 pro, sin ser el fuerte del teléfono, captura vídeos con su cámara interna a 1080p y 30fps,
...
tambien se planteó la inclusión de las mismas en el vídeo, pero se descartó por la falta de ritmo.
 Se planificaron originalmente dos días de grabación,uno para cada parte del vídeo. Las primera parte, más pausada, se grabó en interiores, en el piso de uno de los integrantes.
La mayoría de los planos en esta parte son estáticos, con el protagonista sentado o tumbado en el sofá, 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{assets/Grabacion-parte1.png}
    \caption{Primer día de grabación}
    \label{fig:Grabacion-parte1}
\end{figure}

Mientras que la segunda parte, más frenética, se grabó en exteriores. Permitiendo así una mayor movilidad y posibilidades
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{assets/Grabacion-parte2.jpg}
    \caption{Segundo día de grabación}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth, angle=-90]{assets/Grabacion-parte3.JPG}
    \caption{Tercer día de grabación}
...
\begin{figure}[H]
    ...
    \caption{Selección de la música para la primera parte del vídeo}
    \label{fig:musica1}
\end{figure}

La música es posiblemente el elemento más importante a la hora de marcar el ritmo del vídeo, la mayoría de los cortes
realizados se hicieron siguiendo el compás de la música. Es un proceso técnicamente sencillo, (véase Sección~\ref{sec:montaje1}),
...
\begin{figure}[H]
    ...
    \caption{Montaje de la primera parte del vídeo}
    \label{fig:montaje1}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Selección de la música para la segunda parte del vídeo}
    \label{fig:musica2}
\end{figure}
...
\begin{itemize}
    \item \textbf{Brillo y rayos de luz}
    ...
    \begin{enumerate}[label=\arabic*.]
        ...
        \begin{figure}[H]
            ...
            \caption{Creación de Light-Effect}
            \label{fig:light-effect}
        \end{figure}
    \end{enumerate}

    \item \textbf{Detector de cabeza y \textit{drunk} effects}
    ...
    \begin{enumerate}[label=\arabic*.]
        ...
        \begin{figure}[H]
            ...
            \caption{Configuración Base de Planar Tracker}
        ...
        \begin{figure}[H]
            ...
            \caption{Creación de la ROI para la detección de movimiento}
        ...
        \begin{figure}[H]
            ...
            \caption{Efecto \textit{drunk}}
            \label{fig:drunk}
        \end{figure}
    \end{enumerate}

    \item \textbf{Efecto door loop}
    ...
    \begin{enumerate}[label=\arabic*.]
        ...
        \begin{figure}[H]
            ...
            \caption{\textit{Fade in} y \textit{Fade out} sobre el clip de vídeo}
        ...
        \begin{figure}[H]
            ...
            \caption{Rectángulo sobre el clip de la puerta}
        ...
        \begin{figure}[H]
            ...
            \caption{Ajuste del clip en la malla}
        ...
        \begin{figure}[H]
            ...
            \caption{Loop de puertas}
            \label{fig:loop_puertas}
        \end{figure}
    \end{enumerate}

    \item \textbf{Dolly Zoom y Efecto estabilizador}
    ...
    \begin{enumerate}[label=\arabic*.]
        ...
        \begin{figure}[H]
            ...
            \caption{Círculo para efecto \textit{dolly}}
        ...
        \begin{figure}[H]
            ...
            \caption{Desactivar visualización efecto}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.5\textwidth]{assets/estabilizador.png}
            \caption{Opciones indicadas para configurar estabilizador}
