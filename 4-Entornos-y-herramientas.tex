...
\begin{itemize}
    ...
    fondos en la creación y edición de vídeo de forma rápida y sencilla (véase Figura~\ref{fig:recortar-ia-filmora}).
...
\begin{itemize}
    ...
    en numerosos proyectos son los fundidos, deslizamientos, zoom, entre otras (véase Figura~\ref{fig:funcionalidades-canva}).
...
que soportan cada una de las herramientas analizadas en formato de tabla (véase Tabla~\ref{tab:requisitos-tecnicos}).

Por otro lado, a modo resumen, se identifica en formato de tabla (véase Tabla~\ref{tab:caracteristicas}) cada una de las características identificadas sobre las herramientas analizadas.
...
y tras el estudio comparativo de sus requisitos técnicos (véase Tabla~\ref{tab:requisitos-tecnicos}), 
en la siguiente gráfica se representa el nivel de orientación profesional asignado a cada una de ellas
(véase la Figura~\ref{fig:comparativa-herramientas}).

El nivel de orientación profesional mostrado se basa en los requerimientos hardware, 
las capacidades técnicas diferenciales y la usabilidad que cada herramienta ofrece, 
especialmente en relación con usuarios sin experiencia previa.

Asimismo, se ha otorgado una menor valoración a aquellas herramientas que presentan limitaciones 
significativas en sus versiones gratuitas, condicionadas al uso de modelos de suscripción mensual.
...
\begin{axis}[
    ...
    xtick=data,
    ylabel={Nivel de orientación profesional},
    xlabel={Herramienta},
    nodes near coords,
    width=\textwidth,
    height=8cm,
...
\end{axis}
\end{tikzpicture}
\caption{Comparativa visual del nivel técnico entre herramientas de edición}
\label{fig:comparativa-herramientas}
\end{figure}

Finalmente, los autores del presente proyecto concluyeron en la utilización de la herramienta DaVinci
(\ref{subsec:davinci-resolve}) como principal plataforma de trabajo para el desarrollo de la edición 
relacionada con el tráiler de vídeo realizado.