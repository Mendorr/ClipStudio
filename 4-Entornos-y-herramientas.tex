...
\textit{Filmora} es una aplicación de edición de vídeos desarrollada en 2010 con su primera aportación 
...
mejora en la tasa de fotogramas utilizadas en el editor de la aplicación \cite{filmora-historia}.\\
...
\begin{itemize}
    ...
    un aprendizaje gradual de los conceptos y conocimientos necesarios a adquirir \cite{filmora-caracteristicas}. 
    Para usuarios con experiencia en este contexto, suelen familiarizarse con la 
    interfaz y funcionalidades de una forma rápida y sencilla (véase Figura~\ref{fig:interfaz-filmora}, indicando las secciones de la interfaz).

    \begin{figure}[H]
        \centering
        \includegraphics[width=1\textwidth]{assets/interfaz-filmora.png}
        \caption[Filmora]{Interfaz gráfica de \textit{Filmora} dividida por secciones\\ \footnotesize Fuente: Elaboración propia}
        \label{fig:interfaz-filmora}
    \end{figure}
    ...
    para grabar tutoriales y gameplays (véase Figura~\ref{fig:grabador-filmora}).Cuenta con un reencuadrado de vídeo para convertir 
    ...
    fondos en la creación y edición de vídeo de forma rápida y sencilla \cite{filmora-caracteristicas} (véase Figura~\ref{fig:recortar-ia-filmora}).

    \begin{figure}[H]
        \centering
        \includegraphics[width=1\textwidth]{assets/grabador-pantalla-filmora.png}
        \caption[Crear Video Filmora]{Opción para crear vídeos\\ \footnotesize Fuente: Elaboración propia}
        \label{fig:grabador-filmora}
    \end{figure}

    \begin{figure}[H]
        \centering
        \includegraphics[width=1\textwidth]{assets/recortes-ia-filmora.png}
        \caption[Recorte Filmora]{Opción para recortar objetos y fondos con IA\\ \footnotesize Fuente: Elaboración propia}
        \label{fig:recortar-ia-filmora}
    \end{figure}
    ...
    numerosos recursos (véase Figura~\ref{fig:aprendizaje-filmora}), incluyendo un canal de \textit{YouTube} mostrando y enseñando 
    técnicas y trucos para la edición de vídeo \cite{filmora-caracteristicas}. 
    ...
    sus propias creaciones dentro de la herramienta.

    \begin{figure}[H]
        \centering
        \includegraphics[width=1\textwidth]{assets/aprendizaje-filmora.png}
        \caption[Videos Filmora]{Vídeos e instrucciones para aprender sobre \textit{Flimora} desde su página web\\ \footnotesize Fuente: Elaboración propia}
        \label{fig:aprendizaje-filmora}
    \end{figure}
\end{itemize}
...
sus funcionalidades, dispone un plan de suscripción mensual y un plan de uso perpétuo 
por 70 USD.\\
...
descontentos con la plataforma al tener que volver a renovar esa suscripción "permanente" \cite{filmora-caracteristicas}.\\
...
tras imponer internamiente la posesión de una suscripción de pago para acceder a funcionalidades 
más potentes que dispone y la posibilidad exportación de vídeos generados. 
Sin olvidar destacar la contínua aparición de anuncios
...
La aplicación fue lanzada por primera vez en China en 2019, llamada \textbf{JianYing} y \textbf{ViaMaker} a nivel global. Estuvo disponible inicialmente para 
sistemas operativos como \textit{iPhone} y \textit{Android}. En 2020, pasó a llamarse \textit{CapCut} \cite{capcut-wikipedia}.

Actualmente se ha popularizado dentro del marco de creación de contenido en redes sociales gracias 
a sus funcionalidades internas, pudiendo generar buenos resultados y de buena calidad, obteniendo 
...
del vídeo grabado (véase Figura~\ref{fig:funcionalidades-capcut}).
...
(ROI) dentro de la imagen (véase Figura~\ref{fig:imagenes-capcut}).
...
y la \textbf{exportación y publicación} de vídeos en diferentes formatos y calidades \cite{capcut-caracteristicas}.

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{assets/funcionalidades-capcut.png}
    \caption[Interfaz Capcut]{Principales funcionalidades que aporta la interfaz de \textit{CapCut}\\ \footnotesize Fuente: Elaboración propia}
    \label{fig:funcionalidades-capcut}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{assets/imagenes-capcut.png}
    \caption[Funcionalidades CapCut]{Funcionalidades que aporta \textit{CapCut} en la edición de imágenes\\ \footnotesize Fuente: Elaboración propia}
    \label{fig:imagenes-capcut}
\end{figure}
...
\begin{itemize}
    ...
    y a su funcionamiento interno (véase Figura~\ref{fig:interfaz-capcut}).

    Una ventaja que incluye en su interfaz es su adaptabilidad al dispositivo móvil donde se utiliza, 
    por lo que se encuentra comodidad de uso \cite{capcut-caracteristicas}.

    \begin{figure}[H]
        \centering
        \includegraphics[width=1\textwidth]{assets/interfaz-capcut.png}
        \caption[Despliegue Interfaz CapCut]{Desglose principal de la interfaz de \textit{CapCut}\\ \footnotesize Fuente: Elaboración propia}
        \label{fig:interfaz-capcut}
    \end{figure}
    ...
    extensa (véase Figura~\ref{fig:efectos-capcut}). Además, incluye la posibilidad de enlazar la cuenta registrada en la herramienta con 
    plataformas de redes sociales para utilizar audios o plantillas de vídeo que se guardaron allí.

    Incorpora efectos profesionales, pudiendo aplicarse de una forma sencilla, simplemente 
    ...
    funcionalidad que otras herramientas similares no incorporan \cite{capcut-caracteristicas}.

    \begin{figure}[H]
        \centering
        \includegraphics[width=1\textwidth]{assets/efectos-capcut.png}
        \caption[Biblioteca efectos CapCut]{Bliblioteca de efectos que ofrece \textit{CapCut}\\ \footnotesize Fuente: Elaboración propia}
        \label{fig:efectos-capcut}
    \end{figure}
    ...
    mejor el funcionamiento de la herramienta \cite{capcut-aprendizaje}.
\end{itemize}
...
anuncios ni limitaciones por suscripciones de pago, entre otros. 
...
Por otro lado, su empresa creadora \textit{ByteDance}, cofundadora de la famosa 
red social \textit{TikTok}, por sucesos experimentados mundialmente, puede generar cierta incertidumbre
con las políticas de privacidad y la información personal de usuario dentro de esta herramienta \cite{filmora-caracteristicas}. 
...
Canva es una plataforma de diseño gráfico online, intuitiva y accesible, que permite a cualquier 
...
editor de vídeo completo, ofreciendo flexibilidad y control al alcance de todo tipo de usuarios \cite{canva-video}.
...
plataforma que generen atracción por todo tipo de clientes.
...
\begin{itemize}
    ...
    organizar clips y ajustar duraciones (véase Figura~\ref{fig:interfaz-canva}).
    ...
    creados por otras publicaciones o redes sociales \cite{canva-caracteristicas}.

    \begin{figure}[H]
        \centering
        \includegraphics[width=1\textwidth]{assets/interfaz-canva.png}
        \caption[Interfaz Canva]{Diseño de la interfaz que presenta \textit{Canva Video}\\ \footnotesize Fuente: Elaboración propia}
        \label{fig:interfaz-canva}
    \end{figure}
    ...
    plantillas, evitando deslucir el lienzo de trabajo con contenido que al final no se 
    utilizará.
    ...
    en numerosos proyectos son los fundidos, deslizamientos, zoom, entre otras \cite{canva-funcionalidades} (véase Figura~\ref{fig:funcionalidades-canva}).
    
    \begin{figure}[H]
        \centering
        \includegraphics[width=1\textwidth]{assets/funcionalidades-canva.png}
        \caption[Funcionalidades Canva]{Principales funcionalidades que presenta \textit{Canva Video}\\ \footnotesize Fuente: Elaboración propia}
        \label{fig:funcionalidades-canva}
    \end{figure}
    ...
    interfaz de trabajo \cite{canva-aprendizaje}.
    ...
    tipos de exportaciones que soporta y demás \cite{canva-aprendizaje-tutoriales} \cite{canva-ayuda-video}. 

    Cabe destacar lo cuidada que se encuentra su documentación, aplicando explicaciones para las 
    dos versiones más demandadas de su plataforma: versión móvil y versión de escritorio \cite{canva-help}.

\end{itemize}

\subsubsection{Inconvenientes frente a otras alternativas}
A pesar de que \textit{Canva Video} presenta numerosas ventajas que imponen su \textit{ranking} (posicionamiento) 
entre las herramientas más demandadas actualmente en el mercado audiovisual, presenta ciertas desventajas 
que los usuarios han ido experimentando y reportando con su uso \cite{canva-ventajas-desventajas}.
...
\label{subsec:davinci-resolve}

\subsubsection{Descripción inicial}

DaVinci Resolve es un software profesional de edición y postproducción de vídeo desarrollado por la empresa australiana \textit{Blackmagic Design}. Se trata de una herramienta todo-en-uno que integra en una única aplicación la edición de vídeo, corrección de color, efectos visuales (VFX), gráficos en movimiento y postproducción de audio profesional.

Originalmente fue reconocido como un estándar de la industria en corrección de color para cine y televisión, pero con el tiempo evolucionó hasta convertirse en una solución completa de producción audiovisual.

\subsubsection{Objetivos y características}


Unificar en un entorno profesional un programa para la creación, edición y postproducción de contenido audiovisual (véase Figura~\ref{fig:davinci-interfaz}).


\begin{itemize}
    \item Edición no lineal profesional (modo Edit y Cut).
    \item Corrección y etalonaje de color avanzado (modo Color).
    \item Postproducción de audio con Fairlight (modo Fairlight).
    \item Creación de efectos visuales y motion graphics con Fusion.
    \item Trabajo por páginas o espacios de trabajo organizados por fases.
    \item Colaboración multiusuario en proyectos.
    \item Versión gratuita con gran cantidad de funcionalidades.
    \item Compatible con formatos profesionales de cine digital.
\end{itemize}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{assets/davinci-interfaz.jpg}
    \caption[Interfaz DaVinci]{Interfaz que presenta \textit{DaVinci Resolve}\\ \footnotesize Fuente: Elaboración propia}
    \label{fig:davinci-interfaz}
\end{figure}

\subsubsection{Ventajas frente a otras alternativas}

\begin{itemize}
    \item Versión gratuita extremadamente completa.
    \item Integración total de edición, color, audio y VFX en un solo programa.
    \item Herramientas de corrección de color consideradas estándar profesional.
    \item Compatible con flujos de trabajo de cine y televisión.
    \item Compra única en la versión Studio (sin suscripción mensual).
\end{itemize}

En comparación con herramientas como \textit{Adobe Premiere Pro} y \textit{Final Cut Pro}, \textit{DaVinci Resolve} destaca especialmente en corrección de color y en la disponibilidad de una versión gratuita robusta.

\subsubsection{Inconvenientes frente a otras alternativas}

\begin{itemize}
    \item Curva de aprendizaje elevada para usuarios principiantes.
    \item Requiere \textit{hardware} potente para un rendimiento óptimo.
    \item Puede resultar complejo debido a la cantidad de herramientas profesionales.
    \item Menor integración con otros productos de \textit{Adobe} en comparación con \textit{Premiere} dentro del ecosistema \textit{Creative Cloud}.
\end{itemize}

\subsubsection{Conclusiones sobre la herramienta}

\textit{DaVinci Resolve} se posiciona como una de las herramientas más completas del mercado en el ámbito de la producción audiovisual. Poder optar a múltiples herramientas de alta calidad sin tener que recurrir a otras aplicaciones, aún utilizando la versión gratuita. Especialmente recomendable por su corrección de color y postproducción profesional.

Aunque puede resultar exigente en términos de aprendizaje y requisitos técnicos, la amplia cantidad de tutoriales y guías externos que pueden encontrarse sobre la herramiennta la hacen una fuerte candidata.

\subsection{Requisitos técnicos y características clasificadas}
Este apartado sirve de recopilatorio sobre los diferentes requisitos técnicos 
que soportan cada una de las herramientas analizadas en formato de tabla (véase Cuadro~\ref{tab:requisitos-tecnicos}).

Por otro lado, a modo resumen, se identifica en formato de tabla (véase Cuadro~\ref{tab:caracteristicas}) 
cada una de las características identificadas sobre las herramientas analizadas \cite{canva-requisitos} \cite{filmora-requirements} 
\cite{capcut-requirements-android} \cite{capcut-requirements-windows}.

\begin{table}[H]
\centering
\footnotesize
\begin{tabularx}{\textwidth}{|p{3cm}|Y|Y|Y|Y|}
\hline
\textbf{Requisito} & \textbf{Filmora} & \textbf{CapCut} & \textbf{Canva Video} & \textbf{DaVinci Resolve} \\ \hline

Sistema Operativo &
Windows (7–11, x64 y ARM), macOS, iOS, Android &
Windows 10+, macOS, iOS, Android &
Windows, macOS, iOS (14.5+), Android (vía navegador/app) &
Windows 10+, macOS, Linux \\ \hline

Procesador mínimo recomendado &
Intel 6ª gen / Ryzen 3 1300X o superior &
Intel Core i3 o superior (Windows); 4 cores en móvil &
Windows: 1 GHz dual-core; macOS: Intel 64-bit o Apple M1 &
Procesador multinúcleo moderno \\ \hline

RAM mínima &
8 GB &
4 GB (Windows); 2–4 GB (Android) &
4 GB (Windows/macOS) &
8 GB (mínimo), recomendado 16–32 GB \\ \hline

Requisitos gráficos &
GPU dedicada recomendada (GTX 1050 Ti o superior); 2–8 GB VRAM según resolución &
Aceleración GPU (OpenGL ES 3.0 / Vulkan en móvil) &
No exige GPU dedicada específica &
GPU dedicada recomendada (especialmente para color y efectos) \\ \hline

Almacenamiento &
10 GB instalación; SSD recomendado; NVMe 1 TB para 8K &
2 GB (Windows); 4–8 GB libre en móvil &
1 GB escritorio; 50 MB móvil &
SSD recomendado; espacio variable según proyecto \\ \hline

Orientación principal &
Edición avanzada (hasta 8K) &
Edición ligera y móvil &
Edición online basada en navegador &
Edición profesional y corrección de color avanzada \\ \hline

\end{tabularx}
\caption{Comparativa de requisitos técnicos entre herramientas de edición de vídeo}
\label{tab:requisitos-tecnicos}
\end{table}
...
\begin{tabularx}{\textwidth}{|p{3cm}|Y|Y|Y|Y|}
\hline
\textbf{Caractrerística} & \textbf{Filmora} & \textbf{CapCut} & \textbf{Canva Vídeo} & \textbf{DaVinci Resolve} \\ \hline

Interfaz &
Sencilla y muy capaz, diseñada para ser intuitiva y fácil de usar. &
Sencilla, diseñada para ser intuitiva y fácil de usar. &
Estilo sencillo aplicando técnicas \textit{drag-and-drop}, estructura intuitiva &
Integración completa de edición, color, audio y VFX. \\ \hline

Usabilidad &
Orientada a usuarios inexpertos en el muno de la edición y creación de vídeo. &
Orientada a usuarios inexpertos con curva de aprendizaje leve. &
Curva de aprendizaje leve, permitiendo utilizar plantillas bases para agilizar el trabajo. &
Presenta una curva de aprendizaje elevada para usuarios principiantes. \\ \hline 

Funcionalidad &
Cortar, agrefar efectos, múltiples transicionses, sonido, etc. Capturar pantalla, trabajar con vídeo 360º etc. &
Cortar, agregar efectos, múltiples transiciones, efectos de texto, biblioteca musical, sonido, etc. Versión móvil y escritorio. &
Ofrece plantillas profesionales organizadas por tipo. Previsualización de plantillas antes de importarlas. Recortar, dividir, mover elementos en vídeo. &
Edición no lineal, correción y estalonaje de color, crear efectos visuales, colaboración multiusuario, etc. \\ \hline

Aprendizaje &
Incorpora tutoriales y vídeos de aprendizaje en su página web. &
Cuenta con numerosos vídeos en \textit{YouTube}. Ofrecimiento de cursos. &
Documentación bastante detallada, apartados relacionados con el diseño, creación y edición de vídeo. &
Numerosos vídeos en \textit{YouTube} y documentación oficial de buena calidad . \\ \hline

\end{tabularx}
\caption{Comparativa de características entre herramientas de edición de vídeo}
\label{tab:caracteristicas}
\end{table}

\subsection{Conclusiones del análisis de entornos y herramientas}

Una vez analizadas detalladamente las potenciales herramientas presentes en el mercado audiovisual,
y tras el estudio comparativo de sus requisitos técnicos (véase Cuadro~\ref{tab:requisitos-tecnicos}),
se presenta a continuación una valoración comparativa de cada herramienta en función de tres criterios
clave: requerimientos hardware, capacidades técnicas diferenciales y usabilidad para usuarios sin
experiencia previa.

Se ha penalizado aquellas herramientas cuyas funcionalidades avanzadas quedan restringidas a modelos
de suscripción de pago, dado que el presente proyecto tiene como requisito el uso de software gratuito.
La puntuación resultante, en una escala del 1 al 5, se refleja en la Figura~\ref{fig:comparativa-herramientas}.
...
\begin{axis}[
    ...
    ymax=5.5,
    ytick={1,2,3,4,5},
    symbolic x coords={Canva, CapCut, Filmora, DaVinci},
    xtick={Canva, CapCut, Filmora, DaVinci},
    ylabel={Puntuación (1--5)},
    xlabel={Herramienta},
    nodes near coords,
...
\begin{tabular}{cl}
    \hline
    \textbf{Puntuación} & \textbf{Descripción} \\
    \hline
    1 & Básico / orientado al consumidor \\
    2 & Semiprofesional bajo \\
    3 & Semiprofesional \\
    4 & Profesional \\
    5 & Profesional avanzado \\
    \hline
\end{tabular}
\centering
\caption{Comparativa del nivel de orientación profesional entre herramientas de edición de vídeo.}
\label{fig:comparativa-herramientas}
\end{figure}

La figura pone de manifiesto que \textbf{DaVinci Resolve} obtiene la valoración más alta entre las
herramientas analizadas, siendo la única que combina un conjunto de funcionalidades de grado profesional
---incluyendo corrección de color avanzada, edición multicámara y mezcla de audio--- con una versión
gratuita sin restricciones significativas. Por este motivo, los autores del presente proyecto
concluyeron en su adopción como plataforma principal de trabajo para el desarrollo del tráiler de
vídeo (véase la sección~\ref{subsec:davinci-resolve}).