...
\subsubsection{Sistemas operativos y requisitos de instalación}

\textbf{Sistemas operativos compatibles:}

\begin{itemize}
    \item Windows (10 y versiones posteriores).
    \item macOS.
    \item Linux.
\end{itemize}

\textbf{Requisitos generales recomendados:}

\begin{itemize}
    \item Procesador multinúcleo moderno.
    \item 16 GB de RAM (mínimo 8 GB, recomendado 16--32 GB).
    \item Tarjeta gráfica dedicada (especialmente importante para color y efectos).
    \item Almacenamiento SSD recomendado.
    \item Conexión a internet para activación y actualizaciones.
\end{itemize}

La versión gratuita puede descargarse desde la web oficial de Blackmagic Design, mientras que la versión Studio ofrece funciones adicionales como reducción de ruido avanzada, más efectos y soporte para resoluciones superiores.
