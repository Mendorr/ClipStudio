...
\begin{itemize}
    ...
    interfaz y funcionalidades de una forma rápida y sencilla (véase Figura~\ref{fig:interfaz-filmora}).

    \begin{figure}[H]
        \centering
        \includegraphics[width=1\textwidth]{assets/interfaz-filmora.png}
        \caption{Interfaz gráfica de \textit{Filmora} dividida por secciones}
    ...
    \begin{figure}[H]
        ...
        \caption{Opción para crear vídeos}
    ...
    \begin{figure}[H]
        ...
        \caption{Opción para recortar objetos y fondos con IA}
    ...
    \begin{figure}[H]
        ...
        \caption{Vídeos e instrucciones para aprender sobre \textit{Flimora} desde su página web}
...
descontentos con la plataforma al tener que volver a renovar esa subscripción "permanente" \cite{filmora-caracteristicas}.\\
...
y estuvo disponible a nivel internacional \cite{capcut-wikipedia}.
...
\begin{figure}[H]
    ...
    \caption{Principales funcionalidades que aporta la interfaz de \textit{CapCut}}
...
\begin{figure}[H]
    ...
    \caption{Funcionalidades que aporta \textit{CapCut} en la edición de imágenes}
...
\begin{itemize}
    ...
    \begin{figure}[H]
        ...
        \caption{Desglose principal de la interfaz de \textit{CapCut}}
    ...
    \begin{figure}[H]
        ...
        \caption{Bliblioteca de efectos que ofrece \textit{CapCut}}
...
relacionados con las políticas de privacidad y la información personal de usuario dentro de esta herramienta \cite{filmora-caracteristicas}. 
...
\begin{itemize}
    ...
    \begin{figure}[H]
        ...
        \caption{Diseño de la interfaz que presenta \textit{Canva Video}}
    ...
    \begin{figure}[H]
        ...
        \caption{Principales funcionalidades que presenta \textit{Canva Video}}
...
\begin{figure}[H]
    ...
    \caption{Interfaz que presenta \textit{DaVinci Resolve}}
...
\caption{Comparativa del nivel de orientación profesional entre herramientas de edición de vídeo.
         DaVinci Resolve (destacado en verde) fue seleccionada por su equilibrio entre capacidades
         profesionales y acceso gratuito completo.}
