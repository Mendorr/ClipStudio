...
\subsection{\textcolor{pim}{Formatos de vídeo}}

\textcolor{pim}{Un aspecto técnico a tener en cuenta es la gestión de formatos. Lo que 
...
\textcolor{pim}{Esta división es a menudo malinterpretada, asumiendo que la extensión del archivo 
...
\subsubsection{\textcolor{pim}{Los Códecs}}

\textcolor{pim}{La palabra ``códec'' es un acrónimo de los términos ``compresor/descompresor'' 
...
\textcolor{pim}{Los códecs presentan diferentes métodos de compresión:}

\begin{itemize}
    \item \textcolor{pim}{\textbf{Con pérdida (Lossy):} El algoritmo elimina o fusiona información de 
    ...
    \item \textcolor{pim}{\textbf{Sin pérdida (Lossless):} Almacena los datos conservando las propiedades 
    del archivo original. Genera una calidad superior en función de archivos con un tamaño y peso 
    considerablemente mayores.}
\end{itemize}

\textcolor{pim}{Entre los códecs más relevantes en la industria actual destacan~\cite{tipo-formato-arch}:}

\begin{itemize}
    \item \textcolor{pim}{\textbf{H.264:} Es el estándar en la actualidad. Permite una calidad de Alta Definición 
    ...
    \item \textcolor{pim}{\textbf{H.265 (HEVC - High Efficiency Video Coding):} Diseñado como sucesor 
    ...
    \item \textcolor{pim}{\textbf{Apple ProRes:} Formato en propiedad de Apple con prestaciones de 
    ...
    \item \textcolor{pim}{\textbf{DivX / XviD:} Códecs clásicos que popularizaron la distribución 
    de vídeo en resoluciones estándar a través de internet. XviD se presenta como la alternativa de 
    código abierto a DivX.}
\end{itemize}

\subsubsection{\textcolor{pim}{Contenedores de Vídeo}}

\textcolor{pim}{El contenedor es el ``recipiente'' que reúne y sincroniza todos los elementos codificados 
...
\begin{itemize}
    \item \textcolor{pim}{\textbf{MP4 (.mp4):} Es el formato más extendido, versátil y popular. 
    ...
    \item \textcolor{pim}{\textbf{MOV (.mov):} Desarrollado por Apple (QuickTime), es un estándar en la edición 
    ...
    \item \textcolor{pim}{\textbf{MKV (.mkv):} Contenedor de código abierto en tendencia. Su gran fortaleza 
    ...
    \item \textcolor{pim}{\textbf{WEBM (.webm):} Formato de código abierto desarrollado por Google,
    ...
    \item \textcolor{pim}{\textbf{AVI (.avi):} Pionero desarrollado por Microsoft en 1995. 
    ...
    \item \textcolor{pim}{\textbf{WMV (.wmv):} Sucesor del AVI, supera al MP4 en capacidad de compresión y es 
    ...
    \item \textcolor{pim}{\textbf{AVCHD:} Formato de vídeo con alta definición, creado por Sony y Panasonic 
...
\subsubsection{\textcolor{pim}{Selección de formato}}

\textcolor{pim}{La elección del formato adecuado en un flujo de trabajo depende del objetivo que se quiera 
...
\textcolor{pim}{La multitud de opciones obliga a los creadores a hacer más que simplemente elegir 
