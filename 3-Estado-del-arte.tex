...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{Resoluciones.png}
...
\end{figure}
 ...
 \begin{figure} [H]
    \centering
    \includegraphics[width=0.5\linewidth]{editor.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{Clonacion.jpg}
...
\begin{figure}[H]
     \centering
     \includegraphics[width=0.5\linewidth]{etalonaje-y-correcion-de-color-blog-ejemplos.jpg}
 ...
 Este proceso se realiza para lograr una continuidad visual. Por ejemplo, cuando se filma una escena, cada plano puede ser grabado en diferentes momentos del día, con diferentes condiciones de iluminación y enfoque, lo que puede hacer que los colores parezcan diferentes de un plano a otro.(Lourdes Millán - Animun3D)
   \begin{figure}[H]
     \centering
     \includegraphics[width=0.5\linewidth]{Color.jpg}
...
\begin{figure}[H]
     \centering
     \includegraphics[width=0.5\linewidth]{marypoppins.jpg}
 ...
 \begin{figure}[H]
     \centering
     \includegraphics[width=0.5\linewidth]{fuego.jpg}
...
\begin{figure}[H]
     \centering
     \includegraphics[width=0.5\linewidth]{ledvolumes.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{cgi.jpg}
